# Archivo: src/test/resources/features/consultarCuentaView.feature
Feature: Automatización para el servicio SOAP de Vista de Cuenta
  ...
  Background:
    ...
    * def centalta = '0070'
    * def cuenta = '108102523601'

  Scenario: Realizar una vista de cuenta exitosa y validar la respuesta
